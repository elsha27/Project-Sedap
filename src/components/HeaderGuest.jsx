  ...
  return (
    ...
    >
      ...
      >
        <div
          id="button-signup"
          className="flex items-center gap-2 bg-white border-2 border-gray-300 text-green-700 px-4 py-2 rounded-lg cursor-pointer"
        ...
        <div
          id="button-login"
          className="border-2 border-gray-300 text-white px-4 py-2 rounded-lg cursor-pointer"
